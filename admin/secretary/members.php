    ...
    <div class="card-footer d-flex justify-content-between align-items-center">
        ...
        <div>
            ...
            <form method="POST" class="d-inline">
                <input type="hidden" name="forward_to_director" value="1">
            ...
            <!-- Reject -->
            <button class="btn btn-danger btn-sm ml-2" data-toggle="modal" data-target="#rejectModal-<?= $m['id'] ?>">
        ...
        <div class="modal-content">
            <form method="POST">
                ...
                <div class="modal-body">
                    <p>You are rejecting the application of <strong><?= sanitize($m['name']) ?></strong>. The applicant will be notified by email.</p>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-danger"><i class="fas fa-times mr-1"></i>Reject &amp; Notify</button>
                </div>
            </form>
        </div>
    </div>
